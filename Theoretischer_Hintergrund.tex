...
Zur Datenerhebung per I²C wurde in erster Instanz ein PICkit Serial Analyzer verwendet. Es stellte sich jedoch heraus, dass die Datenrate bei diesem zu gering war, um eine hohe Datenmenge pro Zeiteinheit zu erheben. Aus diesem Grund wurde für die dynamischen Tests ein Raspberry Pi 4 (4 GB RAM), welche einer I²C Schnittstelle besitzt, mit der Programmiersprache Python, für Datenerfassung- und Verarbeitung verwendet. Des Weiteren wurde für das Erstellen von Neuronalen Netzen die Bibliothek "Tensorflow" verwendet, wobei Keras als High-Level API dient. Die graphische Visualisierung der Daten erfolgt ausschließlich per Pyplot library.

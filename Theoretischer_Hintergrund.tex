...
\begin{figure}
    \centering
    \includegraphics[heigt = 5cm, width = 15cm]{Pictures/Neural_Net.png}
    \caption[Neural Net]{Darstellung eines Neuronalen Netztes}
\end{figure}
 ...
 \begin{figure}
 \includegraphics[height=5cm, width = 15cm]{Pictures/Neuron.png}
 \caption[Neuron]{Darstellung eines Neurons Artifical Intelligence  P. 728}
\end{figure}
